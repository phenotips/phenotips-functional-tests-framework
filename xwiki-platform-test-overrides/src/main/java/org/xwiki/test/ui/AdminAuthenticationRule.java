...
public class AdminAuthenticationRule extends AuthenticationRule
{
    ...
    public AdminAuthenticationRule(TestUtils testUtils, WebDriver driver, boolean autologin)
    {
        super("Admin", "admin", testUtils, driver, autologin, "first_name", "Administrator", "last_name", "");
    }
}
